...
export class API {
  ...
  public static CHANGE_MOBILE = 'user/changemobilenumber';
  public static CHANGE_EMAIL = 'user/changeemailid';
  public static CHANGE_COMPANY_ACCOUNT_DETAILS = 'changerecruiteraccountdetails';
  public static VERIFY_CHANGED_EMAIL = 'user/verifychangedemailid';
  ...
  public static VERIFY_OTP = 'user/verifyotp';
  public static VERIFY_MOBILE = 'user/verifymobilenumber';
